...
public class StoreController {
    ...
    public ResponseEntity<StoreDto.StoreResponse> getStoreInfo(@PathVariable String storeId){
        StoreDto.StoreResponse response = StoreDto.StoreResponse.builder()
                .id(storeId)
                .name("외요네 떡국")
                .build();
    ...
    public ResponseEntity<List<ItemDto.StoreItemResponse>> getItems(@PathVariable String storeId){
        ItemDto.StoreItemResponse item1 = ItemDto.StoreItemResponse.builder()
                .id("uuid")
                .name("계란 지단")
                .imageUrl("https://i.namu.wiki/i/lSYFuyRW6FITfZXjJq7cyyqqEYvbMrRx1jvElj09o1XBx2OAUsNZDk9_dOs-5Qx_xPYGF8pRVHTXYd_R4efqEa-vz6kEf5Eq60LICOyLg37p95trbmdLdO7mzl9sG3wAY3OyeDxrzlWB2Ysf8ILzqw.webp")
                .cost(500)
                .sellCounts(1)
                .build();

        ItemDto.StoreItemResponse item2 = ItemDto.StoreItemResponse.builder()
                .id("uuid")
                .name("애호박 지단")
                .imageUrl("https://i.namu.wiki/i/lSYFuyRW6FITfZXjJq7cyyqqEYvbMrRx1jvElj09o1XBx2OAUsNZDk9_dOs-5Qx_xPYGF8pRVHTXYd_R4efqEa-vz6kEf5Eq60LICOyLg37p95trbmdLdO7mzl9sG3wAY3OyeDxrzlWB2Ysf8ILzqw.webp")
                .cost(400)
    ...
    public ResponseEntity<List<GuestBookDto.GuestBookResponse>> getGuestBookInfo(
            @PathVariable String storeId){
        GuestBookDto.GuestBookResponse guestbook1 = GuestBookDto.GuestBookResponse.builder()
                .id("uuid")
                .writerId("wirterid")
                .writerNickname("외요")
        ...
        GuestBookDto.GuestBookResponse guestbook2 = GuestBookDto.GuestBookResponse.builder()
                .id("uuid")
                .writerId("wirterid")
                .writerNickname("외요")
                .writerImageUrl("외요의이미지")
    ...
    public ResponseEntity<GuestBookDto.GuestBookResponse> createGuestBook(
        ...
        GuestBookDto.GuestBookResponse response = GuestBookDto.GuestBookResponse.builder()
                .id("uuid")
                .writerId(userId)
                .writerNickname("외요")
